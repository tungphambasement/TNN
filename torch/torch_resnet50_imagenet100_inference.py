...
class ImageNet100Dataset(Dataset):
    """
    ImageNet-100 dataset loader (validation split).
    Expects directory layout:
      train.X1/<class_id>/*.JPEG  (used to build canonical class->idx mapping)
...
class ResNet50ImageNet100(nn.Module):
    ...
    Matches create_imagenet100_resnet50() architecture.
    """
