...
void gemm(const device_ptr &A, const device_ptr &B, const device_ptr &C, const size_t M,
          const size_t N, const size_t K, const bool trans_A, const bool trans_B, const IO_T alpha,
          const IO_T beta, const size_t lda, const size_t ldb, const size_t ldc) {
