...
// For large payloads, skip per-message MSG_PREPARE/MSG_READY and write directly
// into pre-registered remote ring slots exchanged during QP setup.
constexpr size_t ROCE_DIRECT_SLOT_COUNT = 16;
