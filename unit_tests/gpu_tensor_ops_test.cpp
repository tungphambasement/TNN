...
TEST_F(GPUopsTest, PadBasic) {
  ...
  Tensor gpu_padded = Tensor::create<float>({1, 1, 5, 5}, getGPU());
...
TEST_F(GPUopsTest, PadMultiChannel) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_padded = Tensor::create<float>({2, 3, 8, 8}, getGPU());
...
TEST_F(GPUopsTest, PadAsymmetric) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_padded = Tensor::create<float>({1, 2, 11, 9}, getGPU());
...
TEST_F(GPUopsTest, UnpadBasic) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_unpadded = Tensor::create<float>({1, 1, 3, 3}, getGPU());
...
TEST_F(GPUopsTest, UnpadMultiChannel) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_unpadded = Tensor::create<float>({2, 3, 4, 4}, getGPU());
...
TEST_F(GPUopsTest, PadUnpadRoundTrip) {
  ...
  Tensor gpu_padded = Tensor::create<float>({1, 2, 8, 8}, getGPU());
  ops::pad<float>(gpu_original, gpu_padded, 2, 2, 0.0f);
  Tensor gpu_restored = Tensor::create<float>({1, 2, 4, 4}, getGPU());
...
TEST_F(GPUopsTest, CropBasic) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_cropped = Tensor::create<float>({1, 1, 3, 3}, getGPU());
...
TEST_F(GPUopsTest, CropMultiChannel) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_cropped = Tensor::create<float>({2, 3, 6, 6}, getGPU());
...
TEST_F(GPUopsTest, CropCorner) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_cropped = Tensor::create<float>({1, 2, 4, 4}, getGPU());
...
TEST_F(GPUopsTest, SliceBatchBasic) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_sliced = Tensor::create<float>({2, 2, 3, 3}, getGPU());
...
TEST_F(GPUopsTest, SliceBatchSingle) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_sliced = Tensor::create<float>({1, 3, 4, 4}, getGPU());
...
TEST_F(GPUopsTest, SliceBatchFirstBatch) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_sliced = Tensor::create<float>({1, 2, 5, 5}, getGPU());
...
TEST_F(GPUopsTest, Im2colBasicKernel3x3) {
  ...
  Tensor gpu_col_data = Tensor::create<float>({col_size}, getGPU());
...
TEST_F(GPUopsTest, Col2imBasic) {
  ...
  Tensor gpu_result = Tensor::create<float>({batch_size * channels * height * width}, getGPU());
...
TEST_F(GPUopsTest, Im2colCol2imRoundTrip) {
  ...
  Tensor gpu_reconstructed = Tensor::create<float>({1, 1, 6, 6}, getGPU());
...
TEST_F(GPUopsTest, CombinedPadCropSlice) {
  ...
  Tensor gpu_original = cpu_original->to_gpu();
  Tensor gpu_padded = Tensor::create<float>({4, 3, 12, 12}, getGPU());
  ops::pad<float>(gpu_original, gpu_padded, 2, 2, 0.0f);
  Tensor gpu_cropped = Tensor::create<float>({4, 3, 6, 6}, getGPU());
  ops::crop<float>(gpu_padded, gpu_cropped, 3, 3, 8, 8);
  Tensor gpu_sliced = Tensor::create<float>({2, 3, 6, 6}, getGPU());
...
TEST_F(GPUopsTest, LargeTensorOperations) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_padded = Tensor::create<float>({8, 16, 36, 36}, getGPU());
  ...
  Tensor gpu_cropped = Tensor::create<float>({8, 16, 22, 22}, getGPU());
  ...
  Tensor gpu_sliced = Tensor::create<float>({4, 16, 32, 32}, getGPU());
...
TEST_F(GPUopsTest, MinimalTensor) {
  ...
  ops::pad<float>(cpu_tensor, cpu_padded, 1, 1, 0.0f);
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_padded = Tensor::create<float>({1, 1, 3, 3}, getGPU());
  ops::pad<float>(gpu_tensor, gpu_padded, 1, 1, 0.0f);
...
TEST_F(GPUopsTest, AsymmetricDimensions) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_padded = Tensor::create<float>({1, 1, 24, 13}, getGPU());
  ...
  Tensor gpu_padded2 = Tensor::create<float>({1, 1, 13, 24}, getGPU());
