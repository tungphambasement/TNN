...
protected:
  ...
  void compareTensors(const Tensor &expected, const Tensor &actual,
    ...
    auto expected_tensor = tensor_cast<T>(expected_cpu);
    auto actual_tensor = tensor_cast<T>(actual_cpu);
...
TEST_F(GPUTensorOpsTest, PadBasic) {
  ...
  Tensor gpu_padded = make_tensor<float>({1, 1, 5, 5}, gpu_device_);
...
TEST_F(GPUTensorOpsTest, PadMultiChannel) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_padded = make_tensor<float>({2, 3, 8, 8}, gpu_device_);
...
TEST_F(GPUTensorOpsTest, PadAsymmetric) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_padded = make_tensor<float>({1, 2, 11, 9}, gpu_device_);
...
TEST_F(GPUTensorOpsTest, UnpadBasic) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_unpadded = make_tensor<float>({1, 1, 3, 3}, gpu_device_);
...
TEST_F(GPUTensorOpsTest, UnpadMultiChannel) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_unpadded = make_tensor<float>({2, 3, 4, 4}, gpu_device_);
...
TEST_F(GPUTensorOpsTest, PadUnpadRoundTrip) {
  ...
  Tensor gpu_padded = make_tensor<float>({1, 2, 8, 8}, gpu_device_);
  TensorOps::pad<float>(gpu_original, gpu_padded, 2, 2, 0.0f);
  Tensor gpu_restored = make_tensor<float>({1, 2, 4, 4}, gpu_device_);
...
TEST_F(GPUTensorOpsTest, CropBasic) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_cropped = make_tensor<float>({1, 1, 3, 3}, gpu_device_);
...
TEST_F(GPUTensorOpsTest, CropMultiChannel) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_cropped = make_tensor<float>({2, 3, 6, 6}, gpu_device_);
...
TEST_F(GPUTensorOpsTest, CropCorner) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_cropped = make_tensor<float>({1, 2, 4, 4}, gpu_device_);
...
TEST_F(GPUTensorOpsTest, SliceBatchBasic) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_sliced = make_tensor<float>({2, 2, 3, 3}, gpu_device_);
...
TEST_F(GPUTensorOpsTest, SliceBatchSingle) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_sliced = make_tensor<float>({1, 3, 4, 4}, gpu_device_);
...
TEST_F(GPUTensorOpsTest, SliceBatchFirstBatch) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_sliced = make_tensor<float>({1, 2, 5, 5}, gpu_device_);
...
TEST_F(GPUTensorOpsTest, Im2colBasicKernel3x3) {
  ...
  Tensor gpu_col_data = make_tensor<float>({col_size}, gpu_device_);
...
TEST_F(GPUTensorOpsTest, Col2imBasic) {
  ...
  Tensor gpu_result = make_tensor<float>({batch_size * channels * height * width}, gpu_device_);
...
TEST_F(GPUTensorOpsTest, Im2colCol2imRoundTrip) {
  ...
  Tensor gpu_reconstructed = make_tensor<float>({1, 1, 6, 6}, gpu_device_);
...
TEST_F(GPUTensorOpsTest, CombinedPadCropSlice) {
  ...
  Tensor gpu_original = cpu_original->to_gpu();
  Tensor gpu_padded = make_tensor<float>({4, 3, 12, 12}, gpu_device_);
  TensorOps::pad<float>(gpu_original, gpu_padded, 2, 2, 0.0f);
  Tensor gpu_cropped = make_tensor<float>({4, 3, 6, 6}, gpu_device_);
  TensorOps::crop<float>(gpu_padded, gpu_cropped, 3, 3, 8, 8);
  Tensor gpu_sliced = make_tensor<float>({2, 3, 6, 6}, gpu_device_);
...
TEST_F(GPUTensorOpsTest, LargeTensorOperations) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_padded = make_tensor<float>({8, 16, 36, 36}, gpu_device_);
  ...
  Tensor gpu_cropped = make_tensor<float>({8, 16, 22, 22}, gpu_device_);
  ...
  Tensor gpu_sliced = make_tensor<float>({4, 16, 32, 32}, gpu_device_);
...
TEST_F(GPUTensorOpsTest, MinimalTensor) {
  ...
  TensorOps::pad<float>(cpu_tensor, cpu_padded, 1, 1, 0.0f);
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_padded = make_tensor<float>({1, 1, 3, 3}, gpu_device_);
  TensorOps::pad<float>(gpu_tensor, gpu_padded, 1, 1, 0.0f);
...
TEST_F(GPUTensorOpsTest, AsymmetricDimensions) {
  ...
  Tensor gpu_tensor = cpu_tensor->to_gpu();
  Tensor gpu_padded = make_tensor<float>({1, 1, 24, 13}, gpu_device_);
  ...
  Tensor gpu_padded2 = make_tensor<float>({1, 1, 13, 24}, gpu_device_);
