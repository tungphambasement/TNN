...
void ClassTokenLayer::forward_impl(const Tensor &input, Tensor &output, size_t micro_batch_id) {
  if (input->dims() != 3) {
    throw std::runtime_error(
...
void ClassTokenLayer::backward_impl(const Tensor &gradient, Tensor &grad_input,
