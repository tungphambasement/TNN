...
Tensor PositionalEmbeddingLayer::forward_impl(const ConstTensor &input, size_t pid) {
...
Tensor PositionalEmbeddingLayer::backward_impl(const ConstTensor &grad_output, size_t pid) {
