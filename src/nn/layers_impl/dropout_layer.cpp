...
void DropoutLayer::forward_impl(const Tensor &input, Tensor &output, size_t micro_batch_id) {
...
void DropoutLayer::backward_impl(const Tensor &gradient, Tensor &grad_input,
