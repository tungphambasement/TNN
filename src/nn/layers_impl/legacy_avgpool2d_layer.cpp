...
std::string LegacyAvgPool2DLayer::type() const { return "legacy_avgpool2d"; }
...
std::unique_ptr<Layer> LegacyAvgPool2DLayer::create_from_config(const LayerConfig &config) {
