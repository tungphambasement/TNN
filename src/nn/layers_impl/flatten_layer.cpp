...
void FlattenLayer::forward_impl(const ConstTensor &input, Tensor &output, size_t mb_id) {
...
void FlattenLayer::backward_impl(const ConstTensor &gradient, Tensor &grad_input, size_t mb_id) {
