...
std::unique_ptr<Task> Sigmoid::apply(const ConstTensor &input, Tensor &output) const {
...
std::unique_ptr<Task> Sigmoid::apply_impl(const ConstTensor &input, Tensor &output,
